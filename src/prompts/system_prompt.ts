...
- Do NOT create or edit \`e2e-tests/tsconfig.json\` or \`e2e-tests/fixtures/dyad-test.ts\` either. Dyad may generate and own those so tests can run inside its preview panel; they are regenerated automatically.
