...
export const SETTING_IDS = {
  ...
  enablePreviewPanelE2E: "setting-enable-preview-panel-e2e",
...
export const SETTINGS_SEARCH_INDEX: SearchableSettingItem[] = [
  ...
  {
    id: SETTING_IDS.enablePreviewPanelE2E,
    label: "Run E2E tests in the preview panel",
    description:
      "Render the preview in a native view and run your app's E2E tests inside it, instead of launching a separate Chromium window",
    keywords: [
      "e2e",
      "test",
      "tests",
