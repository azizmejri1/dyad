...
export const SETTING_IDS = {
  ...
  uiChangeScreenshots: "setting-ui-change-screenshots",
...
export const SETTINGS_SEARCH_INDEX: SearchableSettingItem[] = [
  ...
  {
    id: SETTING_IDS.uiChangeScreenshots,
    label: "Before/After UI Screenshots",
    description:
      "Capture before/after screenshots of visual changes during E2E runs and show them in chat",
    keywords: [
      "screenshot",
      "before",
      "after",
