...
export function TestsPanel() {
  ...
  // user watches them in place. Needs the native preview to render into, and
  // the debugging endpoint that only exists after a restart.
  const previewRunEnabled =
    !!settings?.enableWebContentsViewPreview &&
    !!settings?.enableTestRunInPreview;
