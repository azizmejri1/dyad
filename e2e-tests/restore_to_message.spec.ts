...
testSkipIfWindows(
  ...
  async ({ po }) => {
    ...
    // Click the arrow on the SECOND user message (turn B). This should create a
    // new chat with [userA, assistantA] and revert the app to the state after
    // turn A (i.e. before turn B).
